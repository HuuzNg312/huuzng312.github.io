...
" width="45%" alt="Robot View 1" style="border-radius: 10px;">
  &nbsp;
  <img src="" width="45%" alt="Robot View 2" style="border-radius: 10px;">
  <br><br>
  <img src="" width="60%" alt="Robot View 3" style="border-radius: 10px;">
</div>
